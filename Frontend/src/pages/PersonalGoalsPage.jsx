...
const PersonalGoalsPage = () => {
    ...
    const fetchGoals = async () => {
        try {
            const response = await axios.get(`https://tasmit-task-management-application-1.onrender.com/goals/user/${user.id}`);
    ...
    const addGoal = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await axios.post('https://tasmit-task-management-application-1.onrender.com/goals', {
                userId: user.id,
    ...
    const toggleGoal = async (id) => {
        try {
            ...
            const response = await axios.put(`https://tasmit-task-management-application-1.onrender.com/goals/${id}`, {
    ...
    const updateGoal = async () => {
        ...
        try {
            const response = await axios.put(`https://tasmit-task-management-application-1.onrender.com/goals/${editGoal.id}`, {
    ...
    const deleteGoal = async (id) => {
        ...
        try {
            await axios.delete(`https://tasmit-task-management-application-1.onrender.com/goals/${id}`);
    ...
    const addSubGoal = async (goalId) => {
        ...
        try {
            const response = await axios.post(`https://tasmit-task-management-application-1.onrender.com/goals/${goalId}/subgoals`, {
    ...
    const toggleSubGoal = async (goalId, subGoalId, completed) => {
        try {
            const response = await axios.put(`https://tasmit-task-management-application-1.onrender.com/goals/${goalId}/subgoals/${subGoalId}`, {
                completed: !completed
            });
